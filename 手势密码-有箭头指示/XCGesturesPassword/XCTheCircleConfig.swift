...
let MybackgroundColor = UIColor.brown
/** 外空心圆普通状态背景颜色  */
...
/** 外空心圆错误状态颜色 */
let circleOutErrorBorderColor = XCRGBA(r: 250, g: 80, b: 90, a: 1)
/** 内实心圆普通状态颜色 */
let circleInNormalColor = UIColor.clear
/** 内实心圆选中状态颜色 */
let circleInSelectedColor = XCRGBA(r: 35, g: 180, b: 250, a: 1)
/** 内实心圆错误状态颜色 */
let circleInErrorColor = XCRGBA(r: 250, g: 80, b: 90, a: 1)
...
/** 指示三角形错误状态颜色 */
let trangleErrorColor = XCRGBA(r: 250, g: 80, b: 90, a: 1)
...
/** 头部信息视图圆半径 默认5 */
let circleInfoRadius:CGFloat = 5
/** 解锁界面左右边距 默认30 */
